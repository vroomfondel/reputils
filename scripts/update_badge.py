...
def main() -> None:
    ...
    repo_name = os.environ["GITHUB_REPOSITORY"]  # needs full repo-name with username e.g. vroomfondel/reputils

    history_filename = "reputils_clone_history.json"
    badge_filename = "reputils_clone_count.json"
